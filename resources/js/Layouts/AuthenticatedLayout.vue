...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 ">
            <nav
                class=" border-b border-gray-100 bg-white dark:border-gray-700  fixed w-full top-0 z-10 dark:bg-gray-800 ">
                <!-- Primary Navigation Menu -->
                <div class="mx-auto  max-w-8xl px-4 sm:px-6 lg:px-8 ">
                    <div class="flex h-16 justify-between">
                        <div class="flex flex-auto mt-3 sm:gap-6">
                            <!-- Logo -->
                            ...
                            <!-- Navigation Links -->
                            <div class="hidden space-x-8 h-10  sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <div class="-me-2 flex items-center sm:hidden">
                            <button @click="
                                ...
                                !showingNavigationDropdown
                                "
                                class="inline-flex items-center justify-centercreate rounded-md p-2 text-gray-400 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-500 focus:bg-gray-100 focus:text-gray-500 focus:outline-none dark:text-gray-500 dark:hover:bg-gray-900 dark:hover:text-gray-400 dark:focus:bg-gray-900 dark:focus:text-gray-400">
...
component_hide {
    opacity: 0;
  animation: ani .4s forwards ease-in-out;
}
</style>
